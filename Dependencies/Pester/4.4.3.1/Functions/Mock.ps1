...
all calls to the mocked command in the current Context block (or Scenario block),
if present, or the current Describe block (or Feature block), if there is no
active Context/Scenario. Valid values are Describe, Context, It, Feature or
Scenario. If you use a scope of Describe, Context, Feature or Scenario, the command
will identify all calls to the mocked command in the current Describe, Context,
Feature or Scenario block, as well as all child scopes of that block.
